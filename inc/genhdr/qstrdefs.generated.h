...
QDEF(MP_QSTR_sinobit, (const byte*)"\xe1\x07" "sinobit")
QDEF(MP_QSTR_brightness, (const byte*)"\x4c\x0a" "brightness")
QDEF(MP_QSTR_text_width, (const byte*)"\x21\x0a" "text_width")
...
QDEF(MP_QSTR_get_calibration, (const byte*)"\x46\x0f" "get_calibration")
QDEF(MP_QSTR_set_calibration, (const byte*)"\x52\x0f" "set_calibration")
QDEF(MP_QSTR_start_calibrating, (const byte*)"\xd8\x11" "start_calibrating")
QDEF(MP_QSTR_stop_calibrating, (const byte*)"\xc0\x10" "stop_calibrating")
